		...
		while ($row = mysql_fetch_array($result))   //읽어드린 레코드 만큼..
		{
			...
			if($table=='news'){
				$file_copied_0 = $row[file_copied_0];
					if($file_copied_0){
						$img_area = "<img src='./concert/data/$file_copied_0' art=''>";
					}else{
						$img_area =		"<img src='./concert/data/default.jpg' art=''>";
					}
			}

			echo "      
			<li>
					<a href='./concert/view.php?table=$table&num=$num&page=$page&scale=$scale&style=$style'>
							<div class='scale'>
									$img_area
							</div>
							<dl>
